...
const Banner = () => {
  return (
    <Section>
      <ImgContainer>
        <img width={500} height={400} src={ai16zCommon} alt="Ai16z Common" />
        ...
        <img
          ...
          alt="Ai16z Mythical"
        />
        <img width={500} height={400} src={drugsCommon} alt="Drugs Common" />
      </ImgContainer>
      <Title>
        Join the <br /> DAOdyssey game{" "}
      </Title>
      <BtnContainer>
        <JoiNow href={"https://discord.gg/6DQxR4VR"} target="_blank">
          Join Now
        </JoiNow>
      </BtnContainer>
    </Section>
