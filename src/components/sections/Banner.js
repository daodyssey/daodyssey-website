...
const Banner = () => {
  return (
    <Section>
      <ImgContainer>
        <img src={ai16zCommon} width="500" height="400" alt="Ai16z Common" />
        <img src={ai16zRare} width="500" height="400" alt="Ai16z Rare" />
        <img src={ai16zEpic} width="500" height="400" alt="Ai16z Epic" />
        <img
          src={ai16zLegendary}
          width="500"
          height="400"
        ...
        <img
          ...
          alt="Ai16z Mythical"
        />
        <img src={drugsCommon} width="500" height="400" alt="Drugs Common" />
      </ImgContainer>
      <Title>
        Join the
        <br />
